<?php
  ...
  $query = "SELECT * from transaksi_sewa WHERE id_transaksi = '".$nomor."'";
  $query2 = $conn->query($query)->fetchAll();
  
  $query4 = "SELECT nama_tamu from tamu where id_tamu = (select id_tamu from transaksi_sewa where id_transaksi = $nomor)";
